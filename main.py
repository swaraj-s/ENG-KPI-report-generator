...
if st.sidebar.button("🚀 Run Effort Breakdown"):
    ...
    # === Final merge ===
    people = [
     {"Name?": "Abhishek Patro", "Target SP": null, "Senior Dev": "No"},
    ...
    {"Name?": "Saranya R", "Target SP": null, "Senior Dev": "No"},
